        ...
        <div className="row align-items-center">
          <div className="col-md-6 col-12">
            ...
            <div className='d-flex gap-3'>
              <Link className="btn btn-primary" to="/menhelyek">Menhelyek</Link>
              <Link className="btn btn-secondary" to="/regisztracio/menhely">Regisztráció</Link>
            </div>
            <br />
          </div>
      ...
      <section className="mt-5">
        ...
        <div className="row">
          <div className="col-md-6 col-12 d-flex flex-column align-items-center text-center">
            <img src={ikontappancs} alt="ikon" className="img-fluid mb-2" style={{ width: '70px' }} />
          ...
          <div className="col-md-6 col-12 d-flex flex-column align-items-center text-center">
            <img src={ikonbeszed} alt="ikon" className="img-fluid mb-2" style={{ width: '70px' }} />
            <div className="col-lg-7">
              <h2>Állandó elérhetőség</h2>
              <p>A MenhelyTérkép oldal bármikor elérhető, hogy megtalálhassd a legmegfelelőbb menhelyet. Ha kérdésed akad ügyfélszolgálatunk e-mail: info@menhelyterkepek.hu</p>
            </div>
          </div>
        </div>
        ...
        <div className="row mt-4">
          <div className="col-md-6 col-12 d-flex flex-column align-items-center text-center">
            <img src={ikonhaz} alt="ikon" className="img-fluid mb-2" style={{ width: '70px' }} />
            <div className="col-lg-7">
              <h2>Ideiglenes örökbe fogadás</h2>
              <p>Az ideiglenes befogadás remek lehetőség mindazoknak, akik szeretnének segíteni a menhelyen élő állatoknak, de nem tudnak hosszú távra elköteleződni...</p>
            </div>
          </div>
          <div className="col-md-6 col-12 d-flex flex-column align-items-center text-center">
            <img src={ikonnagyito} alt="ikon" className="img-fluid mb-2" style={{ width: '70px' }} />
            <div className="col-lg-7">
              <h2>Költöztetés</h2>
              <p>Az állatok átköltöztetése az új otthonba nagy változás számukra. Az összes menhelyünk szívesen segít, hogy az átmenet minél gördülékenyebb legyen...</p>
            </div>
          </div>
        </div>
      </section>
