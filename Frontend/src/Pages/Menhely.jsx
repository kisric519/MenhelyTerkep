        ...
        <section className="main">
          <div className="row align-items-center">
            ...
            <div className="col-md-7 col-12">
              ...
              <p>
                <strong>Menhely címe: </strong>
                {menhelyAdatok.menhelycime}
              </p>
              <p>
                <strong>Menhely oldala: </strong>
                {menhelyAdatok.oldallink}
              </p>
              <p>
                <strong>Menhely száma: </strong>
                {menhelyAdatok.telefonszam}
              </p>
              <p>
                <strong>Menhely e-mail címe: </strong>
                {menhelyAdatok.email}
              </p>
            </div>
          </div>
