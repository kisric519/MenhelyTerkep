    ...
    const esemenyekLekerese = async () => {
      ...
      try {
        const response = await fetch(
          apiUrl + "/naptar/esemenyek/" + mentettMenhelyId,
        );
      ...
      {esemenyek.map((esemeny) => (
        ...
        >
          ...
          <div className="d-flex">
            <button
              className="gombok"
              onClick={() => esemenyModosit(esemeny._id)}
            >
              Módosítás
            </button>
            <button
              className="gombok"
              onClick={() => esemenyTorles(esemeny._id)}
            >
              Törlés
            </button>
          </div>
      ...
      {esemenyModositasAblak == true ? (
        <section className="ujAblak">
          <div className="tartalom">
            <button
              onClick={() => setEsemenyModositasAblak(false)}
              className="ujgomb"
            >
              Bezár
            </button>
